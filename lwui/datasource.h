...
struct datasource {
	...
	template<typename T> void link(T& v) { data = (void*)&v; size = sizeof(T); mask = 0; count = 0; }
	template<typename T> void link(T& v, unsigned m) { data = (void*)&v; size = sizeof(T); mask = m; count = 0; }
